...
{
	// First Method
	//vec3 crntPos = vec3(model * translation * rotation * scale * vec4(-aPos.x, -aPos.y, -aPos.z, 1.0f));
    //gl_Position = camMatrix * vec4(crntPos, 1.0);
	//gl_Position = camMatrix * vec4(crntPos, 1.0);

	// Second Method
	vec3 crntPos = vec3(model * translation * rotation * scale * vec4(-aPos.x, -aPos.y, -aPos.z + aNormal.z * outlining, 1.0f));
	gl_Position = camMatrix * vec4(crntPos, 1.0);
